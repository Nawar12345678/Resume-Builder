    ...
    return (
        <div className='space-y-6'>
            <div className='flex items-center justify-between'>
                ...
                <button onClick={AddExperience} className='flex items-center gap-2 px-1 py-1 text-sm bg-green-100 text-green-700 rounded-lg hover:bg-green-200 transition-colors'>
                    ...
                    {data.map((experience, index) => (
                        <div key={index} className='p-4 border-gray-200 rounded-lg space-y-3'>
                            ...
                            <label className='flex items-center gap-2'>
                                ...
                                <span className='tsxt-sm text-gray-700'>Currently working here</span>
                            </label>

                            <div className='space-y-2'>
                                <div className='flex items-center justify-between'>
                                    <label className='text-sm font-medium text-gray-700 '>Jop Description</label>
