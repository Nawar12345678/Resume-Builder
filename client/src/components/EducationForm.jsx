    ...
    return (
        <div className='space-y-6'>
            <div className='flex items-center justify-between'>
                ...
                <button onClick={AddEducation} className='flex items-center gap-2 px-1 py-1 text-sm bg-green-100 text-green-700 rounded-lg hover:bg-green-200 transition-colors'>
