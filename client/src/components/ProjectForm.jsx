    ...
    return (
        <div>
            <div className='flex items-center justify-between'>
                ...
                <button onClick={addProject} className='flex items-center gap-2 px-1 py-1 text-sm bg-green-100 text-green-700 rounded-lg hover:bg-green-200 transition-colors'>
                    ...
                    <div key={index} className='p-4 border-gray-200 rounded-lg space-y-3'>
                        ...
                        <div className='grid gap-3'>
                            ...
                            <input value={project.type || ""}
                                ...
                                type='text' placeholder="Project Type (e.g., Web App, Mobile App)"
                                className='px-3 py-2 text-sm rounded-lg' />
