...
const Features = () => {
    ...
    return (
        ...
        <Title title='Build your resume' description='Our stremlined process helps you create a professional resume in minutes with intelligent AI-Powered tools and feautres.' />
