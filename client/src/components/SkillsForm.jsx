    ...
    return (
        <div className='space-y-4'>
            ...
            <div className='flex gap-2'>
                <input type='text' placeholder="Enter a sill (e.g., javaScript, Project Manager)"
            ...
            {data.length > 0 ? (
                <div className='flex flex-wrap gap-2'>
                    {data.map((skill, index) => (
                        <span key={index} className='flex items-center gap-1 px-1 py-1 bg-blue-100 text-blue-800 rounded-full text-sm'>
                            {skill}
